package ch.luoar.selbstregistrierung.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ch.luoar.selbstregistrierung.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ch.luoar.selbstregistrierung.repository.UserRepository.USERS_BY_EMAIL_CACHE);
